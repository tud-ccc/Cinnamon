...
// Write five CSV files: {prefix}_scatter.csv, {prefix}_gather.csv,
// {prefix}_launch.csv, {prefix}_free.csv, {prefix}_alloc.csv, containing all
// rows collected since program start.
