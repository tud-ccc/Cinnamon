module {
    func.func @mm_dimm1_nopt(%A: tensor<1x1024xi32>, %B: tensor<1024x512xi32>) {
    ...
    func.func @mm_dimm1_opt(%A: tensor<16x64xi32>, %B: tensor<64x512xi32>) {
    ...
    func.func @mm_dimm2_nopt(%A: tensor<1x1024xi32>, %B: tensor<1024x256xi32>) {
    ...
    func.func @mm_dimm2_opt(%A: tensor<16x64xi32>, %B: tensor<64x256xi32>) {
    ...
    func.func @mm_dimm4_nopt(%A: tensor<1x1024xi32>, %B: tensor<1024x128xi32>) {
    ...
    func.func @mm_dimm4_opt(%A: tensor<16x64xi32>, %B: tensor<64x128xi32>) {
