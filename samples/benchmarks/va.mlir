module {
     func.func @va_flat(%A: tensor<16777216xi32>, %B: tensor<16777216xi32>) {
        
        %res = cinm.compute { workgroupShape=array<i64: 8, 128> } -> tensor<16777216xi32> {
            %r = cinm.op.add %A, %B: tensor<16777216xi32>
            cinm.yield %r: tensor<16777216xi32>
        }
