...
module {
  func.func @forward(%arg0: index, %arg1: index, %arg2: memref<6x1024x768xf32>, %arg3: memref<6x1024x768xf32>, %arg4: memref<32000x768xf32>, %arg5: memref<6x768xf32>, %arg6: memref<6x768x768xf32>, %arg7: memref<6x768x768xf32>, %arg8: memref<6x768x768xf32>, %arg9: memref<6x768x768xf32>, %arg10: memref<6x2048x768xf32>, %arg11: memref<6x768x2048xf32>, %arg12: memref<6x2048x768xf32>, %arg13: memref<6x768xf32>, %arg14: memref<768xf32>, %arg15: memref<32000x768xf32>) -> memref<32000xf32> attributes {cinm.available_platforms = [#upmem]} {
    ...
    scf.for %arg16 = %c0 to %c6 step %c1 {
      %4 = cinm.compute_block (%arg17 = %alloc_10 : memref<f32>, %arg18 = %subview : memref<768xf32, strided<[1], offset: ?>>) -> f32 attributes {cinm.available_platforms = [#upmem]} {
        %cst_17 = arith.constant 0.000000e+00 : f32
        linalg.generic {indexing_maps = [#map], iterator_types = []} outs(%arg17 : memref<f32>) {
        ^bb0(%out: f32):
          linalg.yield %cst_17 : f32
        }
        linalg.generic {indexing_maps = [#map1, #map2], iterator_types = ["reduction"]} ins(%arg18 : memref<768xf32, strided<[1], offset: ?>>) outs(%arg17 : memref<f32>) {
        ^bb0(%in: f32, %out: f32):
          %17 = arith.mulf %in, %in : f32
          %18 = arith.addf %17, %out : f32
          linalg.yield %18 : f32
        }
        %16 = memref.load %arg17[] : memref<f32>
        cinm.yield %16 : f32
      }
      ...
      cinm.compute_block (%arg17 = %arg5 : memref<6x768xf32>, %arg18 = %arg16 : index, %arg19 = %subview : memref<768xf32, strided<[1], offset: ?>>, %arg20 = %7 : f32, %arg21 = %alloc_9 : memref<768xf32>) attributes {cinm.available_platforms = [#upmem]} {
        %subview_17 = memref.subview %arg17[%arg18, 0] [1, 768] [1, 1] : memref<6x768xf32> to memref<768xf32, strided<[1], offset: ?>>
        linalg.generic {indexing_maps = [#map1, #map2, #map1, #map1], iterator_types = ["parallel"]} ins(%arg19, %arg20, %subview_17 : memref<768xf32, strided<[1], offset: ?>>, f32, memref<768xf32, strided<[1], offset: ?>>) outs(%arg21 : memref<768xf32>) {
        ^bb0(%in: f32, %in_18: f32, %in_19: f32, %out: f32):
          %16 = arith.mulf %in, %in_18 : f32
          %17 = arith.mulf %16, %in_19 : f32
          linalg.yield %17 : f32
        }
        cinm.yield
      }
      cinm.compute_block (%arg17 = %arg6 : memref<6x768x768xf32>, %arg18 = %arg16 : index, %arg19 = %alloc_9 : memref<768xf32>, %arg20 = %alloc_9 : memref<768xf32>) attributes {cinm.available_platforms = [#upmem]} {
        %cst_17 = arith.constant 0.000000e+00 : f32
        %subview_18 = memref.subview %arg17[%arg18, 0, 0] [1, 768, 768] [1, 1, 1] : memref<6x768x768xf32> to memref<768x768xf32, strided<[768, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map1], iterator_types = ["parallel"]} outs(%arg19 : memref<768xf32>) {
        ^bb0(%out: f32):
          linalg.yield %cst_17 : f32
        }
        linalg.generic {indexing_maps = [#map3, #map4, #map5], iterator_types = ["parallel", "reduction"]} ins(%subview_18, %arg20 : memref<768x768xf32, strided<[768, 1], offset: ?>>, memref<768xf32>) outs(%arg19 : memref<768xf32>) attrs =  {cinm.debug_tag = "cinm.op.gemv", linalg.memoized_indexing_maps = [#map3, #map4, #map5]} {
        ^bb0(%in: f32, %in_19: f32, %out: f32):
          %16 = arith.mulf %in, %in_19 : f32
      ...
      %8 = cinm.compute_block (%arg17 = %arg7 : memref<6x768x768xf32>, %arg18 = %arg16 : index, %arg19 = %alloc_8 : memref<6x1024x768xf32>, %arg20 = %arg1 : index, %arg21 = %alloc_9 : memref<768xf32>) -> memref<768xf32, strided<[1], offset: ?>> attributes {cinm.available_platforms = [#upmem]} {
        %cst_17 = arith.constant 0.000000e+00 : f32
        %subview_18 = memref.subview %arg17[%arg18, 0, 0] [1, 768, 768] [1, 1, 1] : memref<6x768x768xf32> to memref<768x768xf32, strided<[768, 1], offset: ?>>
        %subview_19 = memref.subview %arg19[%arg18, %arg20, 0] [1, 1, 768] [1, 1, 1] : memref<6x1024x768xf32> to memref<768xf32, strided<[1], offset: ?>>
        linalg.generic {indexing_maps = [#map1], iterator_types = ["parallel"]} outs(%subview_19 : memref<768xf32, strided<[1], offset: ?>>) {
        ^bb0(%out: f32):
          linalg.yield %cst_17 : f32
        }
        linalg.generic {indexing_maps = [#map3, #map4, #map5], iterator_types = ["parallel", "reduction"]} ins(%subview_18, %arg21 : memref<768x768xf32, strided<[768, 1], offset: ?>>, memref<768xf32>) outs(%subview_19 : memref<768xf32, strided<[1], offset: ?>>) attrs =  {cinm.debug_tag = "cinm.op.gemv", linalg.memoized_indexing_maps = [#map3, #map4, #map5]} {
        ^bb0(%in: f32, %in_20: f32, %out: f32):
          %16 = arith.mulf %in, %in_20 : f32
          %17 = arith.addf %out, %16 : f32
          linalg.yield %17 : f32
        }
        cinm.yield %subview_19 : memref<768xf32, strided<[1], offset: ?>>
      }
      ...
      %subview_16 = memref.subview %arg2[%arg16, %arg1, 0] [1, 1, 768] [1, 1, 1] : memref<6x1024x768xf32> to memref<768xf32, strided<[1], offset: ?>>
      memref.copy %8, %subview_16 : memref<768xf32, strided<[1], offset: ?>> to memref<768xf32, strided<[1], offset: ?>>
      %11 = arith.addi %arg1, %c1 : index
      scf.for %arg17 = %c0 to %c768 step %c48 {
        scf.for %arg18 = %c0 to %11 step %c1 {
          %18 = cinm.compute_block (%arg19 = %alloc_9 : memref<768xf32>, %arg20 = %arg17 : index, %arg21 = %arg2 : memref<6x1024x768xf32>, %arg22 = %arg16 : index, %arg23 = %arg18 : index, %arg24 = %alloc_10 : memref<f32>) -> f32 attributes {cinm.available_platforms = [#upmem]} {
            %cst_18 = arith.constant 0.000000e+00 : f32
            %subview_19 = memref.subview %arg19[%arg20] [48] [1] : memref<768xf32> to memref<48xf32, strided<[1], offset: ?>>
            %subview_20 = memref.subview %arg21[%arg22, 0, 0] [1, 1024, 768] [1, 1, 1] : memref<6x1024x768xf32> to memref<1024x768xf32, strided<[768, 1], offset: ?>>
            %subview_21 = memref.subview %subview_20[%arg23, %arg20] [1, 48] [1, 1] : memref<1024x768xf32, strided<[768, 1], offset: ?>> to memref<48xf32, strided<[1], offset: ?>>
            linalg.generic {indexing_maps = [#map], iterator_types = []} outs(%arg24 : memref<f32>) {
            ^bb0(%out: f32):
              linalg.yield %cst_18 : f32
            }
            linalg.generic {indexing_maps = [#map1, #map1, #map2], iterator_types = ["reduction"]} ins(%subview_19, %subview_21 : memref<48xf32, strided<[1], offset: ?>>, memref<48xf32, strided<[1], offset: ?>>) outs(%arg24 : memref<f32>) {
            ^bb0(%in: f32, %in_22: f32, %out: f32):
              %21 = arith.mulf %in, %in_22 : f32
              %22 = arith.addf %21, %out : f32
              linalg.yield %22 : f32
            }
            %20 = memref.load %arg24[] : memref<f32>
            cinm.yield %20 : f32
          }
        ...
        %16 = cinm.compute_block (%arg18 = %alloc_10 : memref<f32>, %arg19 = %alloc_7 : memref<1024xf32>) -> f32 attributes {cinm.available_platforms = [#upmem]} {
          %cst_18 = arith.constant 0xFFC00000 : f32
          linalg.generic {indexing_maps = [#map], iterator_types = []} outs(%arg18 : memref<f32>) {
          ^bb0(%out: f32):
            linalg.yield %cst_18 : f32
          }
          linalg.generic {indexing_maps = [#map1, #map2], iterator_types = ["reduction"]} ins(%arg19 : memref<1024xf32>) outs(%arg18 : memref<f32>) {
          ^bb0(%in: f32, %out: f32):
            %19 = arith.maxnumf %in, %out : f32
            linalg.yield %19 : f32
          }
          %18 = memref.load %arg18[] : memref<f32>
          cinm.yield %18 : f32
        }
        cinm.compute_block (%arg18 = %alloc_7 : memref<1024xf32>, %arg19 = %16 : f32) attributes {cinm.available_platforms = [#upmem]} {
          ...
          ^bb0(%in: f32, %in_18: f32, %out: f32):
            %18 = arith.subf %in, %in_18 : f32
            %19 = math.exp %18 : f32
            linalg.yield %19 : f32
          }
          cinm.yield
        }
        %17 = cinm.compute_block (%arg18 = %alloc_10 : memref<f32>, %arg19 = %alloc_7 : memref<1024xf32>) -> f32 attributes {cinm.available_platforms = [#upmem]} {
          %cst_18 = arith.constant 0.000000e+00 : f32
          linalg.generic {indexing_maps = [#map], iterator_types = []} outs(%arg18 : memref<f32>) {
          ^bb0(%out: f32):
            linalg.yield %cst_18 : f32
        ...
        cinm.compute_block (%arg18 = %alloc_7 : memref<1024xf32>, %arg19 = %17 : f32, %arg20 = %alloc_7 : memref<1024xf32>) attributes {cinm.available_platforms = [#upmem]} {
          ...
          ^bb0(%in: f32, %in_18: f32, %out: f32):
            %18 = arith.divf %in, %in_18 : f32
            linalg.yield %18 : f32
          }
          cinm.yield
        }
        %subview_17 = memref.subview %alloc_9[%arg17] [48] [1] : memref<768xf32> to memref<48xf32, strided<[1], offset: ?>>
        linalg.generic {indexing_maps = [#map1], iterator_types = ["parallel"]} outs(%subview_17 : memref<48xf32, strided<[1], offset: ?>>) {
        ^bb0(%out: f32):
        ...
        scf.for %arg18 = %c0 to %11 step %c1 {
          ...
          cinm.compute_block (%arg19 = %alloc_9 : memref<768xf32>, %arg20 = %arg17 : index, %arg21 = %arg3 : memref<6x1024x768xf32>, %arg22 = %arg16 : index, %arg23 = %arg18 : index, %arg24 = %18 : f32) attributes {cinm.available_platforms = [#upmem]} {
            %subview_18 = memref.subview %arg19[%arg20] [48] [1] : memref<768xf32> to memref<48xf32, strided<[1], offset: ?>>
            %subview_19 = memref.subview %arg21[%arg22, 0, 0] [1, 1024, 768] [1, 1, 1] : memref<6x1024x768xf32> to memref<1024x768xf32, strided<[768, 1], offset: ?>>
            %subview_20 = memref.subview %subview_19[%arg23, %arg20] [1, 48] [1, 1] : memref<1024x768xf32, strided<[768, 1], offset: ?>> to memref<48xf32, strided<[1], offset: ?>>
            linalg.generic {indexing_maps = [#map1, #map1, #map2, #map1], iterator_types = ["parallel"]} ins(%subview_18, %subview_20, %arg24 : memref<48xf32, strided<[1], offset: ?>>, memref<48xf32, strided<[1], offset: ?>>, f32) outs(%subview_18 : memref<48xf32, strided<[1], offset: ?>>) {
            ^bb0(%in: f32, %in_21: f32, %in_22: f32, %out: f32):
              %19 = arith.mulf %in_21, %in_22 : f32
      ...
      cinm.compute_block (%arg17 = %arg9 : memref<6x768x768xf32>, %arg18 = %arg16 : index, %arg19 = %alloc_9 : memref<768xf32>, %arg20 = %subview : memref<768xf32, strided<[1], offset: ?>>) attributes {cinm.available_platforms = [#upmem]} {
        %subview_17 = memref.subview %arg17[%arg18, 0, 0] [1, 768, 768] [1, 1, 1] : memref<6x768x768xf32> to memref<768x768xf32, strided<[768, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map3, #map4, #map5], iterator_types = ["parallel", "reduction"]} ins(%subview_17, %arg19 : memref<768x768xf32, strided<[768, 1], offset: ?>>, memref<768xf32>) outs(%arg20 : memref<768xf32, strided<[1], offset: ?>>) attrs =  {cinm.debug_tag = "cinm.op.gemv", linalg.memoized_indexing_maps = [#map3, #map4, #map5]} {
        ^bb0(%in: f32, %in_18: f32, %out: f32):
          %16 = arith.mulf %in, %in_18 : f32
          %17 = arith.addf %out, %16 : f32
          linalg.yield %17 : f32
      ...
      %12 = cinm.compute_block (%arg17 = %alloc_10 : memref<f32>, %arg18 = %subview : memref<768xf32, strided<[1], offset: ?>>) -> f32 attributes {cinm.available_platforms = [#upmem]} {
        %cst_17 = arith.constant 0.000000e+00 : f32
        linalg.generic {indexing_maps = [#map], iterator_types = []} outs(%arg17 : memref<f32>) {
        ^bb0(%out: f32):
          linalg.yield %cst_17 : f32
      ...
      cinm.compute_block (%arg17 = %arg10 : memref<6x2048x768xf32>, %arg18 = %arg16 : index, %arg19 = %alloc : memref<2048xf32>, %arg20 = %alloc_9 : memref<768xf32>) attributes {cinm.available_platforms = [#upmem]} {
        %cst_17 = arith.constant 0.000000e+00 : f32
        %subview_18 = memref.subview %arg17[%arg18, 0, 0] [1, 2048, 768] [1, 1, 1] : memref<6x2048x768xf32> to memref<2048x768xf32, strided<[768, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map1], iterator_types = ["parallel"]} outs(%arg19 : memref<2048xf32>) {
        ^bb0(%out: f32):
          linalg.yield %cst_17 : f32
        }
        linalg.generic {indexing_maps = [#map3, #map4, #map5], iterator_types = ["parallel", "reduction"]} ins(%subview_18, %arg20 : memref<2048x768xf32, strided<[768, 1], offset: ?>>, memref<768xf32>) outs(%arg19 : memref<2048xf32>) attrs =  {cinm.debug_tag = "cinm.op.gemv", linalg.memoized_indexing_maps = [#map3, #map4, #map5]} {
        ^bb0(%in: f32, %in_19: f32, %out: f32):
          %16 = arith.mulf %in, %in_19 : f32
          %17 = arith.addf %out, %16 : f32
          linalg.yield %17 : f32
      ...
      cinm.compute_block (%arg17 = %arg11 : memref<6x768x2048xf32>, %arg18 = %arg16 : index, %arg19 = %alloc : memref<2048xf32>, %arg20 = %alloc : memref<2048xf32>, %arg21 = %subview : memref<768xf32, strided<[1], offset: ?>>) attributes {cinm.available_platforms = [#upmem]} {
        ...
        %subview_18 = memref.subview %arg17[%arg18, 0, 0] [1, 768, 2048] [1, 1, 1] : memref<6x768x2048xf32> to memref<768x2048xf32, strided<[2048, 1], offset: ?>>
        linalg.generic {indexing_maps = [#map3, #map4, #map4, #map5], iterator_types = ["parallel", "reduction"]} ins(%subview_18, %arg19 : memref<768x2048xf32, strided<[2048, 1], offset: ?>>, memref<2048xf32>) outs(%arg20, %arg21 : memref<2048xf32>, memref<768xf32, strided<[1], offset: ?>>) {
        ^bb0(%in: f32, %in_19: f32, %out: f32, %out_20: f32):
          %16 = arith.negf %out : f32
          %17 = math.exp %16 : f32
          %18 = arith.addf %17, %cst_17 : f32
          %19 = arith.divf %cst_17, %18 : f32
          %20 = arith.mulf %out, %19 : f32
          %21 = arith.mulf %20, %in_19 : f32
          %22 = arith.mulf %in, %21 : f32
          %23 = arith.addf %out_20, %22 : f32
          linalg.yield %21, %23 : f32, f32
        }
        cinm.yield
      }
    }
    %alloc_11 = memref.alloc() {alignment = 64 : i64} : memref<f32>
    %0 = cinm.compute_block (%arg16 = %alloc_11 : memref<f32>, %arg17 = %subview : memref<768xf32, strided<[1], offset: ?>>) -> f32 attributes {cinm.available_platforms = [#upmem]} {
      %cst_16 = arith.constant 0.000000e+00 : f32
      linalg.generic {indexing_maps = [#map], iterator_types = []} outs(%arg16 : memref<f32>) {
      ^bb0(%out: f32):
        linalg.yield %cst_16 : f32
      }
      linalg.generic {indexing_maps = [#map1, #map2], iterator_types = ["reduction"]} ins(%arg17 : memref<768xf32, strided<[1], offset: ?>>) outs(%arg16 : memref<f32>) {
      ^bb0(%in: f32, %out: f32):
        %5 = arith.mulf %in, %in : f32
        %6 = arith.addf %5, %out : f32
        linalg.yield %6 : f32
      }
      %4 = memref.load %arg16[] : memref<f32>
      cinm.yield %4 : f32
    }
    %1 = arith.divf %0, %cst_3 : f32
    %2 = arith.addf %1, %cst_2 : f32
    %3 = math.rsqrt %2 : f32
    %alloc_12 = memref.alloc() {alignment = 64 : i64} : memref<34048x768xf32>
    linalg.generic {indexing_maps = [#map3], iterator_types = ["parallel", "parallel"]} outs(%alloc_12 : memref<34048x768xf32>) {
    ^bb0(%out: f32):
      linalg.yield %cst_6 : f32
    }
    %subview_13 = memref.subview %alloc_12[0, 0] [32000, 768] [1, 1] : memref<34048x768xf32> to memref<32000x768xf32, strided<[768, 1]>>
    memref.copy %arg15, %subview_13 : memref<32000x768xf32> to memref<32000x768xf32, strided<[768, 1]>>
    %alloc_14 = memref.alloc() {alignment = 64 : i64} : memref<34048xf32>
    cinm.compute_block (%arg16 = %alloc_14 : memref<34048xf32>, %arg17 = %alloc_12 : memref<34048x768xf32>, %arg18 = %subview : memref<768xf32, strided<[1], offset: ?>>, %arg19 = %3 : f32, %arg20 = %arg14 : memref<768xf32>) attributes {cinm.available_platforms = [#upmem]} {
      %cst_16 = arith.constant 0.000000e+00 : f32
      ...
      ^bb0(%in: f32, %in_17: f32, %in_18: f32, %in_19: f32, %out: f32):
        %4 = arith.mulf %in_17, %in_18 : f32
        %5 = arith.mulf %4, %in_19 : f32
    ...
    %subview_15 = memref.subview %alloc_14[0] [32000] [1] : memref<34048xf32> to memref<32000xf32, strided<[1]>>
    %cast = memref.cast %subview_15 : memref<32000xf32, strided<[1]>> to memref<32000xf32>
