...
func.func @gemv_4MB(%A: tensor<1024x1024xi32> {cinm.static}, %x: tensor<1024xi32>, %c: i32) -> tensor<1024xi32>
...
func.func @gemv_64MB(%A: tensor<4096x4096xi32> {cinm.static}, %x: tensor<4096xi32>, %c : i32) -> tensor<4096xi32>
  attributes {cinm.available_platforms = [#upmem]} {
...
func.func @gemv_256MB(%A: tensor<8192x8192xi32> {cinm.static}, %x: tensor<8192xi32>, %c : i32) -> tensor<8192xi32>
  attributes {cinm.available_platforms = [#upmem]} {
...
func.func @gemv_512MB(%A: tensor<8192x16384xi32> {cinm.static}, %x: tensor<16384xi32>, %c: i32) -> tensor<8192xi32>
  attributes {cinm.available_platforms = [#upmem]} {
  %5 = cinm.compute -> tensor<8192xi32> {
    %cs = tensor.splat %c : tensor<8192xi32>
