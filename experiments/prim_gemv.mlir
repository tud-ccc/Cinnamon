...
func.func @gemv_4MB(%A: tensor<1024x1024xi32>, %x: tensor<1024xi32>) -> tensor<1024xi32> 
...
func.func @gemv_256MB(%A: tensor<8192x8192xi32>, %x: tensor<8192xi32>) -> tensor<8192xi32> 
  attributes {cinm.available_platforms = [#upmem]} {
...
func.func @gemv_512MB(%A: tensor<8192x16384xi32>, %x: tensor<16384xi32>) -> tensor<8192xi32> 
  attributes {cinm.available_platforms = [#upmem]} {
