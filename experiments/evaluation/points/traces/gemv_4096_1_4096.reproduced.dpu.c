// DPU kernel ATiM's UPMEM backend generates for gemv_4096_1_4096.reproduced.tir.py.
// Regenerate with `python points/dump_atim_c.py --only gemv_4096_1_4096.reproduced`.
...
int main() {
  ...
  for (int32_t k_1_0 = 0; k_1_0 < 16; ++k_1_0) {
    ...
    for (int32_t i_3 = 0; i_3 < 2; ++i_3) {
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 512) + (k_1_0 * 32)) + (i_3 * 16))), A_local + 0, 64);
