// DPU kernel ATiM's UPMEM backend generates for mtv_8192_1_16384.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only mtv_8192_1_16384.published`.
  ...
  for (int32_t i_2 = 0; i_2 < 8; ++i_2) {
    ...
    for (int32_t k_1_0 = 0; k_1_0 < 8; ++k_1_0) {
      ...
      for (int32_t ax0 = 0; ax0 < 2; ++ax0) {
        ...
        mram_read((__mram_ptr void*)(A + ((((tasklet_id * 4096) + (i_2 * 512)) + (k_1_0 * 64)) + cse_var_1)), A_local + cse_var_1, 128);
      }
      ...
      for (int32_t i_4 = 0; i_4 < 2; ++i_4) {
        ...
        for (int32_t k_1_2 = 0; k_1_2 < 32; ++k_1_2) {
          C_rf_global_local[i_4] = (C_rf_global_local[i_4] + (A_local[((i_4 * 32) + k_1_2)] * B_local[k_1_2]));
        }
      }
      mram_write(C_rf_global_local + 0, (__mram_ptr void*)(C_rf_global + ((tasklet_id * 16) + (i_2 * 2))), 8);
    }
  }
}
