# ATiM schedule for ('mmtv', 128, 256, 512), as measured (reproduced).
...
v25, v26, v27 = sch.sample_perfect_tile(loop=l4, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 1, 64])
