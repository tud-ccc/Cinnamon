# ATiM schedule for ('red', 67108864, 1, 1), as measured (reproduced).
# Decisions to transcribe into the CINM configuration space.
b0 = sch.get_block(name="C", func_name="main")
b1 = sch.get_block(name="root", func_name="main")
l2, = sch.get_loops(block=b0)
v3, v4 = sch.sample_perfect_tile2(loop=l2, n=2, min_n_splits=2, max_n_splits=2048, decision=[1024, 65536])
...
v11, v12 = sch.sample_perfect_tile2(loop=l10, n=2, min_n_splits=2, max_n_splits=24, decision=[16, 4096])
...
v23, v24, v25 = sch.sample_perfect_tile(loop=l22, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 16, 32])
...
v37 = sch.sample_categorical(candidates=[0, 16, 64, 512], probs=[0.25, 0.25, 0.25, 0.25], decision=1)
...
sch.annotate(block_or_loop=l46, ann_key="pragma_auto_unroll_max_step", ann_val=16)
sch.annotate(block_or_loop=l46, ann_key="pragma_unroll_explicit", ann_val=0)
l48, l49, l50, l51, l52 = sch.get_loops(block=b41)
sch.annotate(block_or_loop=l48, ann_key="pragma_auto_unroll_max_step", ann_val=16)
...
sch.annotate(block_or_loop=l58, ann_key="pragma_auto_unroll_max_step", ann_val=16)
sch.annotate(block_or_loop=l58, ann_key="pragma_unroll_explicit", ann_val=0)
l64, l65 = sch.get_loops(block=b44)
sch.annotate(block_or_loop=l64, ann_key="pragma_auto_unroll_max_step", ann_val=16)
sch.annotate(block_or_loop=l64, ann_key="pragma_unroll_explicit", ann_val=0)
l66, = sch.get_loops(block=b45)
sch.annotate(block_or_loop=l66, ann_key="pragma_auto_unroll_max_step", ann_val=16)
