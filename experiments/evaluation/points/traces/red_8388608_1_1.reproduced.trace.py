# ATiM schedule for ('red', 8388608, 1, 1), as measured (reproduced).
...
v23, v24, v25 = sch.sample_perfect_tile(loop=l22, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[8, 16, 8])
