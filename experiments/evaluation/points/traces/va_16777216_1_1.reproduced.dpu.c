// DPU kernel ATiM's UPMEM backend generates for va_16777216_1_1.reproduced.tir.py.
// Regenerate with `python points/dump_atim_c.py --only va_16777216_1_1.reproduced`.
