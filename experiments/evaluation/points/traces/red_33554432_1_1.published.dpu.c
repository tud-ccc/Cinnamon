// DPU kernel ATiM's UPMEM backend generates for red_33554432_1_1.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only red_33554432_1_1.published`.
...
int main() {
  ...
  int64_t* B_rf_global_rf_shared_local = (int64_t*) mem_alloc(1 * sizeof(int64_t));
    int64_t* A_local = (int64_t*) mem_alloc(128 * sizeof(int64_t));
    B_rf_global_rf_shared_local[0] = (int64_t)0;
  for (int32_t i_1_1_0 = 0; i_1_1_0 < 2; ++i_1_1_0) {
    for (int32_t i_1_1_1 = 0; i_1_1_1 < 8; ++i_1_1_1) {
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 2048) + (i_1_1_0 * 1024)) + (i_1_1_1 * 128))), A_local + 0, 1024);
      #pragma clang loop unroll(full)
      for (int32_t i_1_1_2 = 0; i_1_1_2 < 128; ++i_1_1_2) {
