// DPU kernel ATiM's UPMEM backend generates for geva_16777216_1_1.reproduced.tir.py.
// Regenerate with `python points/dump_atim_c.py --only geva_16777216_1_1.reproduced`.
...
int main() {
  ...
  for (int32_t i_2 = 0; i_2 < 64; ++i_2) {
    mram_read((__mram_ptr void*)(A + ((tasklet_id * 512) + (i_2 * 8))), A_local + 0, 32);
    mram_read((__mram_ptr void*)(B + ((tasklet_id * 512) + (i_2 * 8))), B_local + 0, 32);
    ...
    mram_write(A_local + 0, (__mram_ptr void*)(C + ((tasklet_id * 512) + (i_2 * 8))), 32);
  }
}
