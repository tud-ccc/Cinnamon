// DPU kernel ATiM's UPMEM backend generates for gemv_8192_1_8192.reproduced.tir.py.
// Regenerate with `python points/dump_atim_c.py --only gemv_8192_1_8192.reproduced`.
  ...
  for (int32_t k_1_0 = 0; k_1_0 < 16; ++k_1_0) {
    for (int32_t k_1_1 = 0; k_1_1 < 2; ++k_1_1) {
      ...
      for (int32_t ax0 = 0; ax0 < 4; ++ax0) {
        ...
        mram_read((__mram_ptr void*)(A + ((((tasklet_id * 2048) + (k_1_0 * 128)) + (k_1_1 * 64)) + cse_var_1)), A_local + cse_var_1, 64);
      }
      ...
      for (int32_t i_4 = 0; i_4 < 4; ++i_4) {
        ...
        for (int32_t k_1_2 = 0; k_1_2 < 16; ++k_1_2) {
          C_rf_global_local[i_4] = (C_rf_global_local[i_4] + ((alpha_val * A_local[((i_4 * 16) + k_1_2)]) * B_local[k_1_2]));
        }
      }
    }
  }
