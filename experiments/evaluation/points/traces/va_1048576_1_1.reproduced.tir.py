# TIR those decisions produced, for ('va', 1048576, 1, 1) (reproduced).
                    ...
                    for i_2 in range(1):
                        for ax0 in range(128):
                            with T.block("A_local"):
                                v0 = T.axis.spatial(1048576, i_0 * 512 + i_1 * 128 + ax0)
                                T.reads(A[v0])
                                T.writes(A_local[v0])
                        ...
                        for i_3 in range(64):
                            for i_4 in range(2):
                                with T.block("C"):
                                    v_i = T.axis.spatial(1048576, i_0 * 512 + i_1 * 128 + i_2 * 128 + i_3 * 2 + i_4)
                            ...
                            for ax0 in range(2):
                                with T.block("C_local"):
                                    v0 = T.axis.spatial(1048576, i_0 * 512 + i_1 * 128 + i_3 * 2 + ax0)
                                    T.reads(C_local[v0])
                                    T.writes(C[v0])
                                    C[v0] = C_local[v0]
