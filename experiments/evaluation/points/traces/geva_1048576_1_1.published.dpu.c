// DPU kernel ATiM's UPMEM backend generates for geva_1048576_1_1.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only geva_1048576_1_1.published`.
...
int main() {
  ...
  mram_read((__mram_ptr void*)(A + (tasklet_id * 64)), A_local + 0, 256);
  mram_read((__mram_ptr void*)(B + (tasklet_id * 64)), B_local + 0, 256);
  ...
  mram_write(A_local + 0, (__mram_ptr void*)(C + (tasklet_id * 64)), 256);
}
