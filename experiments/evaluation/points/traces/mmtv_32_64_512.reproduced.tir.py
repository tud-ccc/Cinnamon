# TIR those decisions produced, for ('mmtv', 32, 64, 512) (reproduced).
                                    ...
                                    for i_3, j_3 in T.grid(1, 2):
                                        ...
                                        for ax0, ax1, ax2 in T.grid(1, 1, 1):
                                            with T.block("C_rf_global_local"):
                                                ...
                                                v2 = T.axis.spatial(64, j_0 * 32 + j_1 * 2 + j_3 + ax2)
                                                T.reads(C_rf_global_local[v0, v1, v2])
                                                T.writes(C_rf_global[v0, v1, v2])
                                                C_rf_global[v0, v1, v2] = C_rf_global_local[v0, v1, v2]
            for i in T.serial(32, annotations={"pragma_auto_unroll_max_step": T.int64(512), "pragma_unroll_explicit": T.int64(0)}):
                for j in range(64):
                    with T.block("C_init"):
