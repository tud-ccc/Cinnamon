// DPU kernel ATiM's UPMEM backend generates for va_1048576_1_1.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only va_1048576_1_1.published`.
...
int main() {
  ...
  for (int32_t i_2 = 0; i_2 < 4; ++i_2) {
    mram_read((__mram_ptr void*)(A + ((tasklet_id * 128) + (i_2 * 32))), A_local + 0, 128);
    mram_read((__mram_ptr void*)(B + ((tasklet_id * 128) + (i_2 * 32))), B_local + 0, 128);
    ...
    mram_write(A_local + 0, (__mram_ptr void*)(C + ((tasklet_id * 128) + (i_2 * 32))), 128);
  }
}
