// DPU kernel ATiM's UPMEM backend generates for red_524288_1_1.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only red_524288_1_1.published`.
...
int main() {
  ...
  for (int32_t i_1_1_0 = 0; i_1_1_0 < 8; ++i_1_1_0) {
    for (int32_t i_1_1_1 = 0; i_1_1_1 < 2; ++i_1_1_1) {
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 512) + (i_1_1_0 * 64)) + (i_1_1_1 * 32))), A_local + 0, 256);
