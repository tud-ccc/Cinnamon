// DPU kernel ATiM's UPMEM backend generates for red_67108864_1_1.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only red_67108864_1_1.published`.
...
int main() {
  ...
  for (int32_t i_1_1_0 = 0; i_1_1_0 < 16; ++i_1_1_0) {
    mram_read((__mram_ptr void*)(A + ((tasklet_id * 2048) + (i_1_1_0 * 128))), A_local + 0, 1024);
