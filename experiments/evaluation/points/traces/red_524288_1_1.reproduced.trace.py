# ATiM schedule for ('red', 524288, 1, 1), as measured (reproduced).
...
v23, v24, v25 = sch.sample_perfect_tile(loop=l22, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[2, 32, 8])
...
l57, l58, l59, l60, l61, l62 = sch.get_loops(block=b43)
l63, l64 = sch.get_loops(block=b44)
l65, = sch.get_loops(block=b45)
b66 = sch.get_block(name="C", func_name="main")
l67, = sch.get_loops(block=b66)
b68 = sch.decompose_reduction(block=b66, loop=l67)
