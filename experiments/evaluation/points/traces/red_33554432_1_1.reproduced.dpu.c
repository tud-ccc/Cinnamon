// DPU kernel ATiM's UPMEM backend generates for red_33554432_1_1.reproduced.tir.py.
// Regenerate with `python points/dump_atim_c.py --only red_33554432_1_1.reproduced`.
...
int main() {
  ...
  for (int32_t i_1_1_0 = 0; i_1_1_0 < 32; ++i_1_1_0) {
    for (int32_t i_1_1_1 = 0; i_1_1_1 < 4; ++i_1_1_1) {
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 4096) + (i_1_1_0 * 128)) + (i_1_1_1 * 32))), A_local + 0, 256);
