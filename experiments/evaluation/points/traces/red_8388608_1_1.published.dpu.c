// DPU kernel ATiM's UPMEM backend generates for red_8388608_1_1.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only red_8388608_1_1.published`.
...
int main() {
  ...
  for (int32_t i_1_1_0 = 0; i_1_1_0 < 16; ++i_1_1_0) {
    mram_read((__mram_ptr void*)(A + ((tasklet_id * 1024) + (i_1_1_0 * 64))), A_local + 0, 512);
    for (int32_t i_1_1_1 = 0; i_1_1_1 < 32; ++i_1_1_1) {
      #pragma clang loop unroll(full)
      for (int32_t i_1_1_2 = 0; i_1_1_2 < 2; ++i_1_1_2) {
        B_rf_global_rf_shared_local[0] = (B_rf_global_rf_shared_local[0] + A_local[((i_1_1_1 * 2) + i_1_1_2)]);
      }
