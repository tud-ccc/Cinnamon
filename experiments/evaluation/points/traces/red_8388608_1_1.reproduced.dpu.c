// DPU kernel ATiM's UPMEM backend generates for red_8388608_1_1.reproduced.tir.py.
// Regenerate with `python points/dump_atim_c.py --only red_8388608_1_1.reproduced`.
...
int main() {
  ...
  for (int32_t i_1_1_0 = 0; i_1_1_0 < 8; ++i_1_1_0) {
    mram_read((__mram_ptr void*)(A + ((tasklet_id * 1024) + (i_1_1_0 * 128))), A_local + 0, 1024);
