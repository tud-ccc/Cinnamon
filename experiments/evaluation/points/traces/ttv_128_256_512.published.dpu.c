// DPU kernel ATiM's UPMEM backend generates for ttv_128_256_512.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only ttv_128_256_512.published`.
...
int main() {
  ...
  for (int32_t k_0 = 0; k_0 < 32; ++k_0) {
    ...
    for (int32_t ax1 = 0; ax1 < 2; ++ax1) {
      ...
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 1024) + (k_0 * 32)) + cse_var_1)), A_local + cse_var_1, 64);
    }
