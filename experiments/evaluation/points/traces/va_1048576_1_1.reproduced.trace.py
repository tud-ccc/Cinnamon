# ATiM schedule for ('va', 1048576, 1, 1), as measured (reproduced).
...
v3, v4, v5, v6, v7 = sch.sample_perfect_tile(loop=l2, n=5, max_innermost_factor=256, min_innermost_factor=1, decision=[2048, 4, 1, 64, 2])
