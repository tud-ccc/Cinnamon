# TIR those decisions produced, for ('ttv', 128, 256, 512) (reproduced).
                            ...
                            for k_0 in range(16):
                                for ax0, ax1, ax2 in T.grid(1, 2, 32):
                                    with T.block("A_local"):
                                        ...
                                        v2 = T.axis.spatial(512, k_0 * 32 + ax2)
                                        T.reads(A[v0, v1, v2])
