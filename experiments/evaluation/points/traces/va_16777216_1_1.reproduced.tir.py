# TIR those decisions produced, for ('va', 16777216, 1, 1) (reproduced).
                    ...
                    for i_2 in range(64):
                        for ax0 in range(32):
                            with T.block("A_local"):
                                v0 = T.axis.spatial(16777216, i_0 * 8192 + i_1 * 2048 + i_2 * 32 + ax0)
                                T.reads(A[v0])
                                T.writes(A_local[v0])
                        ...
                        for ax0 in range(32):
                            with T.block("B_local"):
                                ...
                                T.block_attr({"meta_schedule.cooperative_fetch": 1})
                                B_local[v0] = B[v0]
                        for i_3, i_4 in T.grid(32, 1):
                            with T.block("C"):
                                v_i = T.axis.spatial(16777216, i_0 * 8192 + i_1 * 2048 + i_2 * 32 + i_3 + i_4)
