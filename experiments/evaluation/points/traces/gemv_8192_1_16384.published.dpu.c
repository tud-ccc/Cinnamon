// DPU kernel ATiM's UPMEM backend generates for gemv_8192_1_16384.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only gemv_8192_1_16384.published`.
    ...
    for (int32_t i_3 = 0; i_3 < 2; ++i_3) {
      for (int32_t k_1_1 = 0; k_1_1 < 4; ++k_1_1) {
        for (int32_t ax0 = 0; ax0 < 2; ++ax0) {
          int32_t cse_var_1 = (ax0 * 16);
          mram_read((__mram_ptr void*)(A + (((((tasklet_id * 4096) + (k_1_0 * 256)) + (i_3 * 128)) + (k_1_1 * 32)) + cse_var_1)), A_local + cse_var_1, 64);
        }
        mram_read((__mram_ptr void*)(B + ((k_1_0 * 64) + (k_1_1 * 16))), B_local + 0, 64);
        for (int32_t i_4 = 0; i_4 < 2; ++i_4) {
          for (int32_t k_1_2 = 0; k_1_2 < 16; ++k_1_2) {
            int32_t cse_var_2 = ((i_3 * 2) + i_4);
            C_rf_global_local[cse_var_2] = (C_rf_global_local[cse_var_2] + ((alpha_val * A_local[((i_4 * 16) + k_1_2)]) * B_local[k_1_2]));
          }
        }
      }
    }
