# ATiM schedule for ('mtv', 8192, 1, 16384), as measured (reproduced).
...
v23, v24, v25 = sch.sample_perfect_tile(loop=l12, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[32, 2, 16])
