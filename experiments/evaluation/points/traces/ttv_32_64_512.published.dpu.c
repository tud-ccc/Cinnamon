// DPU kernel ATiM's UPMEM backend generates for ttv_32_64_512.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only ttv_32_64_512.published`.
...
int main() {
  ...
  for (int32_t k_1_0 = 0; k_1_0 < 4; ++k_1_0) {
    for (int32_t j_3 = 0; j_3 < 4; ++j_3) {
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 256) + (k_1_0 * 64)) + (j_3 * 16))), A_local + 0, 64);
      mram_read((__mram_ptr void*)(B + (k_1_0 * 16)), B_local + 0, 64);
      for (int32_t k_1_2 = 0; k_1_2 < 16; ++k_1_2) {
        C_rf_global_local[j_3] = (C_rf_global_local[j_3] + (A_local[k_1_2] * B_local[k_1_2]));
      }
    }
  }
