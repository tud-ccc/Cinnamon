# ATiM schedule for ('mmtv', 32, 64, 512), as measured (reproduced).
...
v35, v36, v37 = sch.sample_perfect_tile(loop=l14, n=3, max_innermost_factor=256, min_innermost_factor=1, decision=[1, 1, 64])
