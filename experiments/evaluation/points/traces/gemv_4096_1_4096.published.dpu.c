// DPU kernel ATiM's UPMEM backend generates for gemv_4096_1_4096.published.tir.py.
// Regenerate with `python points/dump_atim_c.py --only gemv_4096_1_4096.published`.
...
int main() {
  ...
  for (int32_t k_1_0 = 0; k_1_0 < 8; ++k_1_0) {
    ...
    for (int32_t ax0 = 0; ax0 < 2; ++ax0) {
      ...
      mram_read((__mram_ptr void*)(A + (((tasklet_id * 1024) + (k_1_0 * 128)) + cse_var_1)), A_local + cse_var_1, 256);
    }
    ...
    for (int32_t k_1_1 = 0; k_1_1 < 32; ++k_1_1) {
      ...
      for (int32_t i_4 = 0; i_4 < 2; ++i_4) {
        #pragma clang loop unroll(full)
        for (int32_t k_1_2 = 0; k_1_2 < 2; ++k_1_2) {
          int32_t cse_var_2 = (k_1_1 * 2);
          C_rf_global_local[i_4] = (C_rf_global_local[i_4] + ((alpha_val * A_local[(((i_4 * 64) + cse_var_2) + k_1_2)]) * B_local[(cse_var_2 + k_1_2)]));
        }
      }
    }
  }
