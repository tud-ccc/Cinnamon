...
func.func @_2mm_seq_d8(%A: tensor<8x1024xi32>, %B: tensor<1024x256xi32>,  %C: tensor<256x2048xi32>) -> tensor<8x2048xi32>
...
func.func @_2mm_seq_d16(%A: tensor<16x1024xi32>, %B: tensor<1024x256xi32>,  %C: tensor<256x2048xi32>) -> tensor<16x2048xi32>
attributes { cinm.available_platforms = [#upmem] } {
...
func.func @_2mm_seq_d32(%A: tensor<32x1024xi32>, %B: tensor<1024x256xi32>,  %C: tensor<256x2048xi32>) -> tensor<32x2048xi32>
attributes { cinm.available_platforms = [#upmem] } {
...
func.func @_2mm_seq_d64(%A: tensor<64x1024xi32>, %B: tensor<1024x256xi32>,  %C: tensor<256x2048xi32>) -> tensor<64x2048xi32>
attributes { cinm.available_platforms = [#upmem] } {
