#upmem = #upmem.platform<type=v1A, dimensions = 32x128x1>
    ...
    func.func @_3mm_d8(%A: tensor<8x128xi32>, %B: tensor<128x256xi32>, %C: tensor<256x128xi32>,  %D: tensor<128x128xi32>) -> (tensor<8x128xi32>, tensor<8x128xi32>)
...
#upmem = #upmem.platform<type=v1A, dimensions = 32x128x1>
    ...
    func.func @_3mm_d16(%A: tensor<16x128xi32>, %B: tensor<128x256xi32>, %C: tensor<256x128xi32>,  %D: tensor<128x128xi32>) -> (tensor<16x128xi32>, tensor<16x128xi32>)
    attributes { cinm.available_platforms = [#upmem] } {
...
#upmem = #upmem.platform<type=v1A, dimensions = 32x128x1>
    ...
    func.func @_3mm_d32(%A: tensor<32x128xi32>, %B: tensor<128x256xi32>, %C: tensor<256x128xi32>,  %D: tensor<128x128xi32>) -> (tensor<32x128xi32>, tensor<32x128xi32>)
    attributes { cinm.available_platforms = [#upmem] } {
...
#upmem = #upmem.platform<type=v1A, dimensions = 32x128x1>
    ...
    func.func @_3mm_d64(%A: tensor<64x128xi32>, %B: tensor<128x256xi32>, %C: tensor<256x128xi32>,  %D: tensor<128x128xi32>) -> (tensor<64x128xi32>, tensor<64x128xi32>)
    attributes { cinm.available_platforms = [#upmem] } {
