...
Steps 2-3 are transcribed from benchmarks/cinm1/Makefile (the original CINM 1.0
...
# Transcribed from benchmarks/cinm1/Makefile. Steps 1a/1b infer + apply tile sizes
