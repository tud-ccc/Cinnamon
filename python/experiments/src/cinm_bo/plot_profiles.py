...
from cinm_experiments import profiles as profiles_mod  # noqa: E402
from cinm_experiments.plots import save_fig  # noqa: E402
from cinm_experiments.profiles import Graph  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--out",
        type=pathlib.Path,
        help="where to write (default: <first dump>/profiles)",
    )
    args = parser.parse_args(argv)

    roots = args.dumps
    out_dir = args.out or roots[0] / "profiles"
    ...
    save_fig(fig, out_dir, "profiles.pdf")
    return 0
