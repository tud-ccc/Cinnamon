...
module {
    ...
    func.func @va_8(%A: tensor<8x2097152xi32>, %B: tensor<8x2097152xi32>) {
        ...
        %res = cinm.compute attributes { workgroupShape=array<i64: 8, 128, 1> } -> tensor<8x2097152xi32> {
    ...
    func.func @va_16(%A: tensor<16x1048576xi32>, %B: tensor<16x1048576xi32>) {
        ...
        %res = cinm.compute attributes { workgroupShape=array<i64: 16, 128, 1> } -> tensor<16x1048576xi32> {
