...
#scatter0 = affine_map<(w0, w1) -> (w0 * 128 + w1)>
module {
  func.func @va_8(%arg0: tensor<8x2097152xi32>, %arg1: tensor<8x2097152xi32>) {
    ...
    %2 = affine.for %arg2 = 0 to 16777216 step 65536 iter_args(%arg3 = %1) -> (tensor<16777216xi32>) {
      ...
      %102464 = arith.constant dense<[1024, 64]> : tensor<2xi64>
      %exp0 = tensor.reshape %extracted_slice(%102464): (tensor<65536xi32>, tensor<2xi64>) -> tensor<1024x64xi32>
      %exp1 = tensor.reshape %extracted_slice_4(%102464): (tensor<65536xi32>, tensor<2xi64>) -> tensor<1024x64xi32>
      %3 = cnm.workgroup : !cnm.workgroup<8x128>
      %cst_5 = arith.constant dense<0> : tensor<1024x64xi32>
      %4 = cnm.alloc() for %3 : !cnm.buffer<64xi32 on 8x128, level 0>
      %5 = cnm.scatter %exp0 into %4[#scatter0] of %3 : tensor<1024x64xi32> into !cnm.buffer<64xi32 on 8x128, level 0>
      %6 = cnm.alloc() for %3 : !cnm.buffer<64xi32 on 8x128, level 0>
      %7 = cnm.scatter %exp1 into %6[#scatter0] of %3 : tensor<1024x64xi32> into !cnm.buffer<64xi32 on 8x128, level 0>
      %8 = cnm.alloc() for %3 : !cnm.buffer<64xi32 on 8x128, level 0>
      %9 = cnm.scatter %cst_5 into %8[#scatter0] of %3 : tensor<1024x64xi32> into !cnm.buffer<64xi32 on 8x128, level 0>
      ...
      %output, %token = cnm.gather %8[#scatter0] of %3 : !cnm.buffer<64xi32 on 8x128, level 0> into tensor<1024x64xi32>
      %65536 = arith.constant dense<[65536]> : tensor<1xi64>
      %rs = tensor.reshape %output(%65536): (tensor<1024x64xi32>, tensor<1xi64>) -> tensor<65536xi32>
      %inserted_slice = tensor.insert_slice %rs into %arg3[%arg2] [65536] [1] : tensor<65536xi32> into tensor<16777216xi32>
