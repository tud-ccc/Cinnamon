...
func.func @forward(%token : index, %pos : index,
    ...
    // === This is the only difference: QKV is done in a single offloaded gemv
    %qkvweights = tensor.concat dim(0) %wqs, %wks, %wvs : (tensor<768x768xf32>, tensor<768x768xf32>, tensor<768x768xf32>) -> tensor<2304x768xf32>

    %qkv = cinm.op.gemv %qkvweights, %xb : tensor<2304x768xf32>, tensor<768xf32> -> tensor<2304xf32>

    %q = tensor.extract_slice %qkv [0   ] [768] [1] : tensor<2304xf32> to tensor<768xf32>
    %k = tensor.extract_slice %qkv [768 ] [768] [1] : tensor<2304xf32> to tensor<768xf32>
    %v = tensor.extract_slice %qkv [1536] [768] [1] : tensor<2304xf32> to tensor<768xf32>
    /// === End
    ...
    %xb00 = bufferization.materialize_in_destination %xb20 in %xb : (tensor<768xf32>, tensor<768xf32>) -> tensor<768xf32>

		%wo_slice = tensor.extract_slice %wo [%layer, 0, 0] [1, 768, 768] [1, 1, 1] : tensor<6x768x768xf32> to tensor<768x768xf32>
    // final matmul to get the output of the attention
    // + residual connection back into x
    %x0 = cinm.op.gemv %wo_slice, %xb00 plus %x into %x : tensor<768x768xf32>, tensor<768xf32> plus tensor<768xf32> into tensor<768xf32>-> tensor<768xf32>

		// ffn rmsnorm
		%rms_ffn_weight = tensor.extract_slice %rms_ffn_weights [%layer, 0] [1, 768] [1, 1] : tensor<6x768xf32> to tensor<768xf32>
		%tmp = func.call @rmsnorm(%x0, %rms_ffn_weight) : (tensor<768xf32>, tensor<768xf32>) -> tensor<768xf32>
    %xb01 = bufferization.materialize_in_destination %tmp in %xb00 : (tensor<768xf32>, tensor<768xf32>) -> tensor<768xf32>
    ...
    %hb1 = cinm.op.gemv %w1_slice, %xb01 : tensor<2048x768xf32>, tensor<768xf32> -> tensor<2048xf32>
    %hb2 = cinm.op.gemv %w3_slice, %xb01 : tensor<2048x768xf32>, tensor<768xf32> -> tensor<2048xf32>
    ...
    // final matmul to get the output of the ffn + residual connection into x
    %x01 = cinm.op.gemv %w2_slice, %hb11 plus %xb01 into %x0 : tensor<768x2048xf32>, tensor<2048xf32> plus tensor<768xf32> into tensor<768xf32> -> tensor<768xf32>

		scf.yield %x01, %kc2, %vc1 : tensor<768xf32>, tensor<6x1024x768xf32>, tensor<6x1024x768xf32>
	}
