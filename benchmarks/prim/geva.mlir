...
func.func @geva_4MB(%x: tensor<1048576xi32>, %y: tensor<1048576xi32>, %c: i32{cinm.static}, %d: i32{cinm.static}) -> tensor<1048576xi32>
...
func.func @geva_64MB(%x: tensor<16777216xi32>, %y: tensor<16777216xi32>, %c: i32{cinm.static}, %d: i32{cinm.static}) -> tensor<16777216xi32>
  attributes {cinm.available_platforms = [#upmem]} {
...
func.func @geva_256MB(%x: tensor<67108864xi32>, %y: tensor<67108864xi32>, %c: i32{cinm.static}, %d: i32{cinm.static}) -> tensor<67108864xi32>
  attributes {cinm.available_platforms = [#upmem]} {
