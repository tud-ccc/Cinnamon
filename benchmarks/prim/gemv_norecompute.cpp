// out = (A * x) * c as two cinm ops (the scaling of x, then the gemv), the
// no-recompute form of gemv.cpp's computation. A is M×N row-major.

#include "../common.hpp"

extern "C" void BENCH_FN(DTY *, DTY *, DTY, DTY *);

struct GemvNoRecompute {
  static constexpr bench::Size kSizes[] = {
      {"gemv_norecompute_4MB", {1024, 1024}},
      {"gemv_norecompute_64MB", {4096, 4096}},
      {"gemv_norecompute_256MB", {8192, 8192}},
      {"gemv_norecompute_512MB", {8192, 16384}},
  };
...
int main(int argc, char **argv) {
  return bench::run<GemvNoRecompute>(argc, argv);
}
