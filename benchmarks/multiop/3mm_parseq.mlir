...
// parallel to it, sharing the activation X. Size class = bytes of each
// K x M i32 weight (see 2mm_seq.mlir); all three weights are static.
// -----
...
func.func @_3mm_512MB(%X: tensor<8x8192xi32>, %W1: tensor<8192x16384xi32>{cinm.static}, %W2: tensor<16384x8192xi32>{cinm.static}, %W3: tensor<8192x16384xi32>{cinm.static}) -> (tensor<8x8192xi32>, tensor<8x16384xi32>)
attributes { cinm.available_platforms = [#upmem] } {
    ...
    %r3 = cinm.op.gemm %X, %W3 : tensor<8x8192xi32>, tensor<8192x16384xi32> -> tensor<8x16384xi32>
    func.return %r2, %r3 : tensor<8x8192xi32>, tensor<8x16384xi32>
}
