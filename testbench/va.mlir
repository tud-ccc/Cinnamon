...
module {
    ...
    func.func @va_8(%A: tensor<8x2097152xi32>, %B: tensor<8x2097152xi32>) {
        ...
        %res = cinm.compute -> tensor<8x2097152xi32> attributes { workgroupShape=array<i64: 16, 64, 16>, tileSizes=array<i64: 65536> } {
    ...
    func.func @va_16(%A: tensor<16x1048576xi32>, %B: tensor<16x1048576xi32>) {
        ...
        %res = cinm.compute -> tensor<16x1048576xi32> attributes { workgroupShape=array<i64: 32, 64, 8>,
        tileSizes=array<i64: 65536>  } {
