module {
    ...
    func.func @mm_dimm4_nopt(%A: tensor<16x1024xi32>, %B: tensor<1024x128xi32>, %C: tensor<128x2048xi32>) -> tensor<16x2048xi32> {

        %r0 = cinm.compute_ -> tensor<16x2048xi32> attributes { workgroupShape=array<i64: 16, 128, 1> } {
