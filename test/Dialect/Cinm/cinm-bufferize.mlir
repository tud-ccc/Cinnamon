...
// CHECK-LABEL: gemm
    ...
    // CHECK: }
        %r0 = cinm.compute (%a = %A : tensor<8x1024xi32>, %b = %B : tensor<8x1024xi32>) attributes { workgroupShape=array<i64: 8, 128, 1> } -> tensor<8x128xi32> {
...
// CHECK-LABEL: gemv
    ...
    // CHECK: }
        %r0 = cinm.compute (%a = %A : tensor<8x1024xi32>, %b = %B : tensor<8x1024xi32>) attributes { workgroupShape=array<i64: 1, 8, 1> } -> tensor<8xi32> {
