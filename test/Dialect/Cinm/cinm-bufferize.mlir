...
// CHECK-LABEL: gemm
    ...
    // CHECK:  cinm.compute ({{.*}}) -> memref<8x128xi32>
    ...
    // CHECK: }
        ...
        // }
        %r0 = cinm.compute (%a = %A : tensor<8x1024xi32>, %b = %B : tensor<1024x128xi32>) -> tensor<8x128xi32> {
            %r = cinm.op.gemm %a, %b: tensor<8x1024xi32>, tensor<1024x128xi32> -> tensor<8x128xi32>
            cinm.yield %r : tensor<8x128xi32>
        }
...
// CHECK-LABEL: gemv
    ...
    // CHECK:  cinm.compute ({{.*}}) -> memref<8xi32> 
    ...
    // CHECK: }
        %r0 = cinm.compute (%a = %A : tensor<8x1024xi32>, %b = %B : tensor<1024xi32>) -> tensor<8xi32> attributes { workgroupShape=array<i64: 1, 8, 1> } {
