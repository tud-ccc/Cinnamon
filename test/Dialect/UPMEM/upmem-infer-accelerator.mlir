#upmem = #upmem.platform<type = v1A, dimensions = 1x32x24>


// func.func @gemv(%A: tensor<?x?xf32>, %x: tensor<?xf32>) -> tensor<?xf32> {
//   %4 = cinm.compute -> tensor<?xf32> attributes {cinm.available_platforms = [#upmem]} {
//         %18 = cinm.op.gemv %A, %x : tensor<?x?xf32>, tensor<?xf32> -> tensor<?xf32>
//         cinm.yield %18 : tensor<?xf32>
//   }
