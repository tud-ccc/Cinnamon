...
// CHECK: %2 = cim.op.gemm %cim_cbr_0, %arg0, %arg1 : !cim.crossbarId, tensor<6x3xi32>, tensor<3x6xi32> -> !cim.future<6x6xi32>
// CHECK: %3 = cim.barrier %0 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %4 = cim.barrier %1 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %5 = cim.barrier %2 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %6 = cim.op.gemm %cim_cbr_2, %4, %5 : !cim.crossbarId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
// CHECK: %7 = cim.barrier %6 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %8 = cim.op.gemm %cim_cbr_2, %7, %3 : !cim.crossbarId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
