...
// CHECK: %0 = cim.op.gemm %cim_cbr, %arg0, %arg1 : !cim.crossbarId, tensor<6x3xi32>, tensor<3x6xi32> -> !cim.future<6x6xi32>
// CHECK: %1 = cim.barrier %0 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %2 = cim.op.gemm %cim_cbr, %arg0, %arg1 : !cim.crossbarId, tensor<6x3xi32>, tensor<3x6xi32> -> !cim.future<6x6xi32>
// CHECK: %3 = cim.barrier %2 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %4 = cim.op.gemm %cim_cbr, %arg0, %arg1 : !cim.crossbarId, tensor<6x3xi32>, tensor<3x6xi32> -> !cim.future<6x6xi32>
// CHECK: %5 = cim.barrier %4 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %6 = cim.op.gemm %cim_cbr, %3, %5 : !cim.crossbarId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
// CHECK: %7 = cim.barrier %6 : !cim.future<6x6xi32> -> tensor<6x6xi32>
// CHECK: %8 = cim.op.gemm %cim_cbr, %7, %1 : !cim.crossbarId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
