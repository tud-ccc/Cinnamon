...
// CHECK: upmem.scatter %{{.*}}[16 elts, #[[MAPA]]] onto @buf_0 of %[[DPU:.*]] : memref<4x2x8xi32> onto !upmem.hierarchy<1x4x2>
// CHECK: upmem.scatter %{{.*}}[8 elts, #[[MAPB]]] onto @buf of %[[DPU]] : memref<4x8xi32> onto !upmem.hierarchy<1x4x2>
