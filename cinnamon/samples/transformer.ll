...
146:                                              ; preds = %142
  ...
  %148 = mul i64 %143, 288
  %149 = add i64 %147, %148
  %150 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program)
  br label %151
...
187:                                              ; preds = %183
  ...
  %189 = mul i64 %184, 288
  %190 = add i64 %188, %189
  %191 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_0)
  br label %192
...
228:                                              ; preds = %224
  ...
  %230 = mul i64 %225, 288
  %231 = add i64 %229, %230
  %232 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_1)
  br label %233
...
338:                                              ; preds = %334
  ...
  %340 = mul i64 %335, 288
  %341 = add i64 %339, %340
  %342 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_2)
  br label %343
...
373:                                              ; preds = %334
  ...
  %375 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_3)
...
382:                                              ; preds = %378
  ...
  %384 = mul i64 %379, 288
  %385 = add i64 %383, %384
  %386 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_4)
  br label %387
...
423:                                              ; preds = %419
  ...
  %425 = mul i64 %420, 288
  %426 = add i64 %424, %425
  %427 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_5)
  br label %428
...
493:                                              ; preds = %489
  ...
  %495 = mul i64 %490, 768
  %496 = add i64 %494, %495
  %497 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_6)
  br label %498
...
528:                                              ; preds = %489
  ...
  %530 = call ptr @upmemrt_dpu_alloc(i32 1, i32 6, ptr @dpu_program_7)
...
579:                                              ; preds = %575
  %580 = mul i64 %576, 288
  %581 = call ptr @upmemrt_dpu_alloc(i32 2, i32 8, ptr @dpu_program_8)
  br label %582
...
54:                                               ; preds = %50
  %55 = mul i64 %51, 288
  %56 = add i64 %55, %49
  %57 = call ptr @upmemrt_dpu_alloc(i32 1, i32 1, ptr @dpu_program_9)
...
109:                                              ; preds = %105
  ...
  %114 = call ptr @upmemrt_dpu_alloc(i32 1, i32 1, ptr @dpu_program_10)
  ...
  %123 = call ptr @upmemrt_dpu_alloc(i32 1, i32 1, ptr @dpu_program_11)
...
16:                                               ; preds = %7
  ...
  %27 = call ptr @upmemrt_dpu_alloc(i32 1, i32 1, ptr @dpu_program_13)
  ...
  %45 = call ptr @upmemrt_dpu_alloc(i32 1, i32 1, ptr @dpu_program_14)
...
13:                                               ; preds = %4
  ...
  %20 = call ptr @upmemrt_dpu_alloc(i32 1, i32 8, ptr @dpu_program_15)
...
60:                                               ; preds = %51
  ...
  %67 = call ptr @upmemrt_dpu_alloc(i32 1, i32 8, ptr @dpu_program_16)
...
define ptr @rmsnorm_1048576(ptr %0, ptr %1) {
  %3 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_17)
...
37:                                               ; preds = %28
  ...
  %43 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_18)
  ...
  %61 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_19)
...
34:                                               ; preds = %25
  ...
  %36 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_20)
...
97:                                               ; preds = %88
  ...
  %99 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_21)
...
define ptr @va_1048576(ptr %0, ptr %1) {
  %3 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_22)
  call void @upmemrt_dpu_scatter(ptr %3, ptr %0, i64 4, i64 1048576, i64 256, i64 16384, i64 0, ptr @scatter_map_9)
...
define ptr @rmsnorm_262144(ptr %0, ptr %1) {
  %3 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_23)
...
37:                                               ; preds = %28
  ...
  %41 = call float @llvm.sqrt.f32(float %40)
  %42 = fdiv float 1.000000e+00, %41
  %43 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_24)
  ...
  call void @upmemrt_dpu_free(ptr %43)
  %61 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_25)
...
34:                                               ; preds = %25
  %35 = load float, ptr %24, align 4
  %36 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_26)
...
97:                                               ; preds = %88
  %98 = load float, ptr %87, align 4
  %99 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_27)
...
define ptr @rmsnorm_262144_opt(ptr %0, ptr %1) {
  %3 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_28)
  call void @upmemrt_dpu_scatter(ptr %3, ptr %0, i64 4, i64 262144, i64 64, i64 4096, i64 0, ptr @scatter_map_10)
  call void @upmemrt_dpu_scatter(ptr %3, ptr %0, i64 4, i64 262144, i64 64, i64 4096, i64 4096, ptr @scatter_map_10)
  call void @upmemrt_dpu_launch(ptr %3)
...
20:                                               ; preds = %5
  ...
  %41 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_29)
...
11:                                               ; preds = %2
  ...
  %28 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_30)
...
45:                                               ; preds = %30
  ...
  %63 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_31)
...
define ptr @va_262144(ptr %0, ptr %1) {
  %3 = call ptr @upmemrt_dpu_alloc(i32 4, i32 64, ptr @dpu_program_32)
  call void @upmemrt_dpu_scatter(ptr %3, ptr %0, i64 4, i64 262144, i64 64, i64 4096, i64 0, ptr @scatter_map_10)
...
64:                                               ; preds = %60
  %65 = mul i64 %61, 32768
  %66 = add i64 %65, %59
  %67 = call ptr @upmemrt_dpu_alloc(i32 1, i32 16, ptr @dpu_program_33)
...
127:                                              ; preds = %117
  ...
  %133 = call ptr @upmemrt_dpu_alloc(i32 1, i32 16, ptr @dpu_program_34)
...
169:                                              ; preds = %160
  ...
  %175 = call ptr @upmemrt_dpu_alloc(i32 1, i32 16, ptr @dpu_program_35)
...
202:                                              ; preds = %198
  ...
  %207 = call ptr @upmemrt_dpu_alloc(i32 1, i32 16, ptr @dpu_program_36)
  ...
  %224 = call ptr @upmemrt_dpu_alloc(i32 1, i32 16, ptr @dpu_program_37)
