...
module {
  ...
  func.func @rmsnorm_262144_opt(%arg0: memref<262144xf32>, %arg1: memref<262144xf32>) -> memref<262144xf32> {
    ...
    ^bb0(%a: memref<64xf32>, %b: memref<64xf32>, %r: memref<2xf32>):
      %c_0 = arith.constant 0 : index
      %c_1 = arith.constant 1 : index
      %c_2 = arith.constant 2 : index
      %c_64 = arith.constant 64 : index
      %c_0f = arith.constant 0.0 : f32
      memref.store %c_0f, %r[%c_0] : memref<2xf32>
      memref.store %c_0f, %r[%c_1] : memref<2xf32>
      scf.for %i0 = %c_0 to %c_64 step %c_2 {
        %i1 = arith.addi %i0, %c_1 : index
        %a0 = memref.load %a[%i0] : memref<64xf32>
        %b0 = memref.load %b[%i0] : memref<64xf32>
        %r0 = memref.load %r[%c_0] : memref<2xf32>
        %p0 = arith.mulf %a0, %b0 : f32
        %s0 = arith.addf %p0, %r0 : f32
        memref.store %s0, %r[%c_0] : memref<2xf32>

        %a1 = memref.load %a[%i1] : memref<64xf32>
        %b1 = memref.load %b[%i1] : memref<64xf32>
        %r1 = memref.load %r[%c_1] : memref<2xf32>
        %p1 = arith.mulf %a1, %b1 : f32
        %s1 = arith.addf %p1, %r1 : f32
        memref.store %s1, %r[%c_1] : memref<2xf32>
      }
    }

    %alloc = memref.alloc() : memref<4096x2xf32>
    cnm.gather %5[#map6] of %wg0 into %alloc : !cnm.buffer<2xf32 on 4x64x16, level 0> into memref<4096x2xf32>

    cnm.free_workgroup %wg0 : !cnm.workgroup<4x64x16>

    %ss = scf.for %i = %c0 to %c4096 step %c1 iter_args(%acc = %c0f) -> f32 {
    ...
    %14 = cnm.alloc() for %wg1 : !cnm.buffer<64xf32 on 4x64x16, level 0>
    cnm.scatter %reshape_9 into %14[#map6] of %wg1 : memref<4096x64xf32> into !cnm.buffer<64xf32 on 4x64x16, level 0>

    %15 = cnm.alloc() for %wg1 : !cnm.buffer<f32 on 4x64x16, level 0>
    cnm.scatter %alloc_5 into %15[#map1] of %wg1 : memref<16xf32> into !cnm.buffer<f32 on 4x64x16, level 0>

    %c0x4096x64 = memref.get_global @__constant_4096x64xf32 : memref<4096x64xf32>
    %16 = cnm.alloc() for %wg1 : !cnm.buffer<64xf32 on 4x64x16, level 0>
    cnm.scatter %c0x4096x64 into %16[#map6] of %wg1 : memref<4096x64xf32> into !cnm.buffer<64xf32 on 4x64x16, level 0>

    cnm.launch %wg1 in(%13, %14, %15 : !cnm.buffer<64xf32 on 4x64x16, level 0>, !cnm.buffer<64xf32 on 4x64x16, level 0>, !cnm.buffer<f32 on 4x64x16, level 0>) out(%16 : !cnm.buffer<64xf32 on 4x64x16, level 0>) on !cnm.workgroup<4x64x16> {
    ^bb0(%v_buf: memref<64xf32>, %w_buf: memref<64xf32>, %s_buf: memref<f32>, %r_buf: memref<64xf32>):
      ...
      scf.for %i = %c_0 to %c_64 step %c_1 {
        %v = memref.load %v_buf[%i] : memref<64xf32>
        %w = memref.load %w_buf[%i] : memref<64xf32>
    ...
    %alloc_6 = memref.alloc() : memref<4096x64xf32>
    cnm.gather %16[#map6] of %wg1 into %alloc_6 : !cnm.buffer<64xf32 on 4x64x16, level 0> into memref<4096x64xf32>
    %reshape_pattern_2 = memref.get_global @__constant_1xi64_0 : memref<1xi64>
    %reshape_7 = memref.reshape %alloc_6(%reshape_pattern_2) : (memref<4096x64xf32>, memref<1xi64>) -> memref<262144xf32>
  ...
  func.func @softmax_262144_opt(%arg0: memref<262144xf32>) -> memref<262144xf32> {
    ...
    %max = scf.for %i = %c0 to %c262144 step %c1 iter_args(%acc = %cinf) -> f32 {
      %v = memref.load %arg0 [%i] : memref<262144xf32>
      %m = arith.maximumf %v, %acc : f32
      scf.yield %m : f32
    }

    %alloc_2 = memref.alloc() : memref<16xf32>
    memref.store %max, %alloc_2[%c0] : memref<16xf32>
    memref.store %max, %alloc_2[%c1] : memref<16xf32>
    memref.store %max, %alloc_2[%c2] : memref<16xf32>
    memref.store %max, %alloc_2[%c3] : memref<16xf32>
    memref.store %max, %alloc_2[%c4] : memref<16xf32>
    memref.store %max, %alloc_2[%c5] : memref<16xf32>
    memref.store %max, %alloc_2[%c6] : memref<16xf32>
    memref.store %max, %alloc_2[%c7] : memref<16xf32>
    memref.store %max, %alloc_2[%c8] : memref<16xf32>
    memref.store %max, %alloc_2[%c9] : memref<16xf32>
    memref.store %max, %alloc_2[%c10] : memref<16xf32>
    memref.store %max, %alloc_2[%c11] : memref<16xf32>
    memref.store %max, %alloc_2[%c12] : memref<16xf32>
    memref.store %max, %alloc_2[%c13] : memref<16xf32>
    memref.store %max, %alloc_2[%c14] : memref<16xf32>
    memref.store %max, %alloc_2[%c15] : memref<16xf32>
    ...
    %4 = cnm.alloc() for %wg0 : !cnm.buffer<64xf32 on 4x64x16, level 0>
    cnm.scatter %reshape into %4[#map6] of %wg0 : memref<4096x64xf32> into !cnm.buffer<64xf32 on 4x64x16, level 0>

    %5 = cnm.alloc() for %wg0 : !cnm.buffer<f32 on 4x64x16, level 0>
    cnm.scatter %alloc_2 into %5[#map1] of %wg0 : memref<16xf32> into !cnm.buffer<f32 on 4x64x16, level 0>

    %6 = memref.get_global @__constant_4096x64xf32 : memref<4096x64xf32>
    %7 = cnm.alloc() for %wg0 : !cnm.buffer<64xf32 on 4x64x16, level 0>
    cnm.scatter %6 into %7[#map6] of %wg0 : memref<4096x64xf32> into !cnm.buffer<64xf32 on 4x64x16, level 0>

    %8 = memref.get_global @__constant_4096x2xf32 : memref<4096x2xf32>
    %9 = cnm.alloc() for %wg0 : !cnm.buffer<2xf32 on 4x64x16, level 0>
    cnm.scatter %8 into %9[#map6] of %wg0 : memref<4096x2xf32> into !cnm.buffer<2xf32 on 4x64x16, level 0>

    cnm.launch %wg0 in(%4, %5 : !cnm.buffer<64xf32 on 4x64x16, level 0>, !cnm.buffer<f32 on 4x64x16, level 0>) out(%7, %9 : !cnm.buffer<64xf32 on 4x64x16, level 0>, !cnm.buffer<2xf32 on 4x64x16, level 0>) on !cnm.workgroup<4x64x16> {
    ^bb0(%v_buf: memref<64xf32>, %m_buf: memref<f32>, %e_buf: memref<64xf32>, %s_buf: memref<2xf32>):
      %c_0 = arith.constant 0 : index
      %c_1 = arith.constant 1 : index
      %c_2 = arith.constant 2 : index
      %c_64 = arith.constant 64 : index

      %m = memref.load %m_buf[] : memref<f32>
      scf.for %i0 = %c_0 to %c_64 step %c_2 {
        %i1 = arith.addi %i0, %c_1 : index

        %v0 = memref.load %v_buf[%i0] : memref<64xf32>
        %s0 = memref.load %s_buf[%c_0] : memref<2xf32>
        %t0 = arith.subf %v0, %m : f32
        %e0 = math.exp %t0 : f32
        %r0 = arith.addf %s0, %e0 : f32
        memref.store %e0, %e_buf[%i0] : memref<64xf32>
        memref.store %r0, %s_buf[%c_0] : memref<2xf32>

        %v1 = memref.load %v_buf[%i1] : memref<64xf32>
        %s1 = memref.load %s_buf[%c_1] : memref<2xf32>
        %t1 = arith.subf %v1, %m : f32
        %e1 = math.exp %t1 : f32
        %r1 = arith.addf %s1, %e1 : f32
        memref.store %e0, %e_buf[%i1] : memref<64xf32>
        memref.store %r1, %s_buf[%c_1] : memref<2xf32>
      }
    }

    %s_memref = memref.alloc() : memref<4096x2xf32>
    cnm.gather %9[#map6] of %wg0 into %s_memref : !cnm.buffer<2xf32 on 4x64x16, level 0> into memref<4096x2xf32>

    %s = scf.for %i = %c0 to %c4096 step %c1 iter_args(%acc = %c0f) -> f32 {
      %a = memref.load %s_memref[%i, %c0] : memref<4096x2xf32>
      %b = memref.load %s_memref[%i, %c1] : memref<4096x2xf32>
      %c = arith.addf %a, %b : f32
      %r = arith.addf %c, %acc : f32
      scf.yield %r : f32
    }
    ...
    %alloc_10 = memref.alloc() : memref<16xf32>
    memref.store %s, %alloc_10[%c0] : memref<16xf32>
    memref.store %s, %alloc_10[%c1] : memref<16xf32>
    memref.store %s, %alloc_10[%c2] : memref<16xf32>
    memref.store %s, %alloc_10[%c3] : memref<16xf32>
    memref.store %s, %alloc_10[%c4] : memref<16xf32>
    memref.store %s, %alloc_10[%c5] : memref<16xf32>
    memref.store %s, %alloc_10[%c6] : memref<16xf32>
    memref.store %s, %alloc_10[%c7] : memref<16xf32>
    memref.store %s, %alloc_10[%c8] : memref<16xf32>
    memref.store %s, %alloc_10[%c9] : memref<16xf32>
    memref.store %s, %alloc_10[%c10] : memref<16xf32>
    memref.store %s, %alloc_10[%c11] : memref<16xf32>
    memref.store %s, %alloc_10[%c12] : memref<16xf32>
    memref.store %s, %alloc_10[%c13] : memref<16xf32>
    memref.store %s, %alloc_10[%c14] : memref<16xf32>
    memref.store %s, %alloc_10[%c15] : memref<16xf32>

    %alloc_3 = memref.alloc() : memref<4096x64xf32>
    cnm.gather %7[#map6] of %wg0 into %alloc_3 : !cnm.buffer<64xf32 on 4x64x16, level 0> into memref<4096x64xf32>
    cnm.free_workgroup %wg0 : !cnm.workgroup<4x64x16>

    %11 = cnm.workgroup : !cnm.workgroup<4x64x16>
    %12 = cnm.alloc() for %11 : !cnm.buffer<64xf32 on 4x64x16, level 0>
    cnm.scatter %alloc_3 into %12[#map6] of %11 : memref<4096x64xf32> into !cnm.buffer<64xf32 on 4x64x16, level 0>
    ...
    cnm.launch %11 in(%12, %13 : !cnm.buffer<64xf32 on 4x64x16, level 0>, !cnm.buffer<f32 on 4x64x16, level 0>) out(%14 : !cnm.buffer<64xf32 on 4x64x16, level 0>) on !cnm.workgroup<4x64x16> {
    ^bb0(%e_buf: memref<64xf32>, %s_buf: memref<f32>, %r_buf: memref<64xf32>):
      %c_0 = arith.constant 0 : index
      %c_1 = arith.constant 1 : index
      %c_64 = arith.constant 64 : index
      %s0 = memref.load %s_buf[] : memref<f32>
      scf.for %i = %c_0 to %c_64 step %c_1 {
        %15 = memref.load %e_buf[%i] : memref<64xf32>
        %17 = arith.divf %15, %s0 : f32
        memref.store %17, %r_buf[%i] : memref<64xf32>
      }
    }
    ...
    cnm.gather %14[#map6] of %11 into %alloc_11 : !cnm.buffer<64xf32 on 4x64x16, level 0> into memref<4096x64xf32>
    %reshape_pattern_2 = memref.get_global @__constant_1xi64_0 : memref<1xi64>
    %reshape_12 = memref.reshape %alloc_11(%reshape_pattern_2) : (memref<4096x64xf32>, memref<1xi64>) -> memref<262144xf32>
    cnm.free_workgroup %11 : !cnm.workgroup<4x64x16>
    return %reshape_12 : memref<262144xf32>
  }
