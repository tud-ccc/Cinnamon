...
#define DEF_MEMRISTOR_WRITE_TO_CROSSBAR(name, type)                                                                                                                      \
  void memristor_write_to_crossbar_##name(                                                                                                                               \
    ...
    printf("write_to_crossbar_" #name " %d %p\n", crossbar_id, memref_data_ptr);                                                                                         \
...
DEF_MEMRISTOR_WRITE_TO_CROSSBAR(i8, int8_t)
DEF_MEMRISTOR_WRITE_TO_CROSSBAR(i16, int16_t)
DEF_MEMRISTOR_WRITE_TO_CROSSBAR(i32, int32_t)
DEF_MEMRISTOR_WRITE_TO_CROSSBAR(i64, int64_t)
DEF_MEMRISTOR_WRITE_TO_CROSSBAR(f32, float)
DEF_MEMRISTOR_WRITE_TO_CROSSBAR(f64, double)

DEF_MEMRISTOR_GEMM(i8, int8_t)
DEF_MEMRISTOR_GEMM(i16, int16_t)
DEF_MEMRISTOR_GEMM(i32, int32_t)
DEF_MEMRISTOR_GEMM(i64, int64_t)
DEF_MEMRISTOR_GEMM(f32, float)
DEF_MEMRISTOR_GEMM(f64, double)

DEF_MEMRISTOR_GEMV(i8, int8_t)
DEF_MEMRISTOR_GEMV(i16, int16_t)
DEF_MEMRISTOR_GEMV(i32, int32_t)
DEF_MEMRISTOR_GEMV(i64, int64_t)
