...
// CHECK: %2 = cim.barrier %1 : !cim.future<6x6xi32> -> tensor<6x6xi32>
    %r0 = cim.op.gemm %device, %t0, %t1 : !cim.deviceId, tensor<6x3xi32>, tensor<3x6xi32> -> !cim.future<6x6xi32>
// CHECK: %3 = cim.op.gemm %0, %arg2, %arg3 : !cim.deviceId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
// CHECK: %4 = cim.barrier %3 : !cim.future<6x6xi32> -> tensor<6x6xi32>
    %r1 = cim.op.gemm %device, %t2, %t3 : !cim.deviceId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>

// CHECK: %5 = cim.op.gemm %0, %2, %4 : !cim.deviceId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
    %r2 = cim.op.gemm %device, %r0, %r1 : !cim.deviceId, !cim.future<6x6xi32>, !cim.future<6x6xi32> -> !cim.future<6x6xi32>
// CHECK: %6 = cim.op.gemm %0, %2, %4 : !cim.deviceId, tensor<6x6xi32>, tensor<6x6xi32> -> !cim.future<6x6xi32>
